...
python -u weaver/train.py \
 ...
 --model-prefix /fmhwwvol/experiments/mass_regression_v2/model \
 --log-file /fmhwwvol/experiments/mass_regression_v2/logs/train.log \
 --predict-output /fmhwwvol/experiments/mass_regression_v2/predict/pred.root \
 --num-workers 0 \
 --in-memory \
 --steps-per-epoch=1 \
 --tensorboard _v2 \
