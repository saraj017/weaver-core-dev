...
python -u weaver/train.py \
 ...
 --data-config weaver/data_new/finetune/FM_ak8_mass_regression_v12.yaml \
 ...
 --predict-output /fmhwwvol/experiments/mass_regression_v12_load/predict/pred.root \
 --num-workers 0 \
 --in-memory \
 --steps-per-epoch=1 \
 --tensorboard _v12_load \
