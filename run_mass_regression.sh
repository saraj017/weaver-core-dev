...
python -u weaver/train.py \
 ...
 --model-prefix /fmhwwvol/experiments/mass_regression_v2big/model \
 --log-file /fmhwwvol/experiments/mass_regression_v2big/logs/train.log \
 --predict-output /fmhwwvol/experiments/mass_regression_v2big/predict/pred.root \
 --num-workers 0 \
 --in-memory \
 --steps-per-epoch=1 \
 --tensorboard _v2big \
