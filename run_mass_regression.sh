...
python -u weaver/train.py \
 ...
 --data-config weaver/data_new/finetune/mass_regression_v10.yaml \
 --network-config weaver/networks/fintune_test/mlp_2p_gated_regression.py \
 --model-prefix /fmhwwvol/experiments/mass_regression_v10_load/model \
 --log-file /fmhwwvol/experiments/mass_regression_v10_load/logs/train.log \
