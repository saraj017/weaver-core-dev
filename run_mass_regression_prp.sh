...
python -u weaver/train.py \
 ...
 --model-prefix /fmhwwvol/experiments/mass_regression_custom/model \
 --log-file /fmhwwvol/experiments/mass_regression_custom/logs/train.log \
 --predict-output /fmhwwvol/experiments/mass_regression_custom/predict/pred.root \
 --num-workers 0 \
 --in-memory \
 --steps-per-epoch=1 \
 --tensorboard _custom \
