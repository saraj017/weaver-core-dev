...
python -u weaver/train.py \
 ...
 --data-train '/fmhwwvol/ntuples/GluGluHToWW_Pt-200ToInf_M-125/train/*.root' \
 ...
 --model-prefix /fmhwwvol/experiments_sara/mass_regression_higgs125_ft_1/model \
 --log-file /fmhwwvol/experiments_sara/mass_regression_higgs125_ft_1/logs/train.log \
 --predict-output /fmhwwvol/experiments_sara/mass_regression_higgs125_ft_1/predict/pred.root \
 --num-workers 0 \
 --in-memory \
 --steps-per-epoch=1 \
 --tensorboard _v1 \
